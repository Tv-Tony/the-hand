...
public enum ToggleButtonDef {
    ...
    FINGER_ONE_SERVO("Sensor 1 Servo", SeriesDef.FINGER_ONE_SERVO, SeriesDef.FINGER_ONE_SERVO_FILTERED, ChartKey.SERVO_CHART),
    FINGER_TWO_SERVO("Sensor 2 Servo", SeriesDef.FINGER_TWO_SERVO, SeriesDef.FINGER_TWO_SERVO_FILTERED, ChartKey.SERVO_CHART),
    FINGER_THREE_SERVO("Sensor 3 Servo", SeriesDef.FINGER_THREE_SERVO, SeriesDef.FINGER_THREE_SERVO_FILTERED, ChartKey.SERVO_CHART);
