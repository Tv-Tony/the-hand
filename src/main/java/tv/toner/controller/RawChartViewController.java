...
public class RawChartViewController implements Initializable {
    ...
    private final RawChartDataUtil rawChartDataUtil;

    @Autowired
    public RawChartViewController(RawChartDataUtil rawChartDataUtil) {
        this.rawChartDataUtil = rawChartDataUtil;
    }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        rawChartDataUtil.initializeChart(lineChart); // Initialize the chart and store the reference in ChartUtil
    }
